...
# Mine
file copy -force $CL_DIR/design/NN.sv                                  $TARGET_DIR
file copy -force $CL_DIR/design/NN_defines.vh                         $TARGET_DIR
...
encrypt -k $HDK_SHELL_DIR/build/scripts/vivado_keyfile.txt -lang verilog  [glob -nocomplain -- $TARGET_DIR/*.?v] [glob -nocomplain -- $TARGET_DIR/*.vh]
